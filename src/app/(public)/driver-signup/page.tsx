...
const portalBenefits = ["Wisconsin Coverage", "Onboarding Progress Tracking", "Easy Digital Document Uploads"];

export const metadata: Metadata = {
  title: "Create Driver Account | FIKI Transit",
  description: "Create a FIKI Transit driver partner account to submit your job application form.",
};
        ...
        <div className="relative z-10 flex h-full flex-col px-[7%] py-[5vh]">
          ...
          <div className="mt-[11vh]">
            ...
            <p className="mt-6 max-w-md text-[clamp(1rem,1.35vw,1.25rem)] leading-relaxed text-secondary-foreground/70">
              Create an onboarding account to complete your driver credentials, references, and professional transportation details.
            </p>
        ...
        <div className="flex min-h-full flex-col px-5 py-5 sm:px-8 lg:px-10 lg:py-7 xl:px-14">
          ...
          <div className="my-auto min-w-0 max-w-full">
            <div className="mx-auto w-full max-w-130 rounded-[22px] border border-border bg-card px-6 py-7 sm:px-8 sm:py-8">
              <div className="mb-6">
                <h2 className="text-2xl font-bold tracking-[-0.03em] text-foreground">Create Driver Account</h2>
                <p className="mt-1.5 text-sm text-muted-foreground sm:text-base">
                  Set up your driver account to start your job application
                </p>
              </div>
              <DriverSignupForm />
            </div>
