...
const portalBenefits = ["Onboarding Tracking", "Background Verification status", "Direct Vehicle Assignment", "24/7 Dispatch Access"];

export const metadata: Metadata = {
  title: "Driver Sign In | FIKI Transit",
  description: "Sign in to your FIKI Transit driver onboarding portal to track your application status.",
};
...
export default function DriverLoginPage() {
  return (
    <main className="h-svh overflow-hidden bg-background">
      {/* Left panel — navy background matching driver portal */}
        ...
        <div className="relative z-10 flex h-full flex-col px-[7%] py-[5vh]">
          ...
          <div className="mt-[11vh]">
            ...
            <p className="mt-6 max-w-md text-[clamp(1rem,1.35vw,1.25rem)] leading-relaxed text-secondary-foreground/70">
              Access your driver registration dashboard, view application status, and launch the active Driver Portal once approved.
            </p>
            ...
            <div className="mx-auto w-full max-w-130 rounded-[22px] border border-border bg-card px-6 py-7 sm:px-8 sm:py-8">
              <div className="mb-6">
                ...
                <p className="mt-1.5 text-sm text-muted-foreground sm:text-base">
                  Enter your credentials to access your driver registration portal
                </p>
              </div>
              <Suspense>
                <DriverLoginForm />
